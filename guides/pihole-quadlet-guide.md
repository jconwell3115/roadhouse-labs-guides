...
> **New to Pi-hole?** Read the [overview post]({% post_url 2026-04-13-pihole-home-network %}) first for the what and why before diving into this guide.
...
The monitor type should be **Push** with a heartbeat interval of **10080 minutes** (7 days).
...
- **Firebog** — curated collection of lists by category: [firebog.net](https://firebog.net/)
